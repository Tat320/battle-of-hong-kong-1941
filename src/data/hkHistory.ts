...
export const scenes: SceneEntry[] = [
  ...
  },
  {
    ...
    location: '九龍、市區與新界接點',
    body:
      '日佔初期，地下線人先後接應滯留人士，之後沿新界和海上路線轉移至安全地點。這條路線後來延伸成長達十一個月的秘密營救行動。',
    focus: 'rescue',
    tone: 'rescue',
    highlights: [
      ['營救形式', '接應、匿藏、分段護送'],
  ...
  },
  {
    ...
    location: '西貢、元朗、沙頭角、九龍',
    body:
      '大營救並非單點行動，而是一條連接香港市區、新界和華南根據地的地下通道。聯絡站、交通員與村民互相掩護，讓轉移路線可以穩定運作。',
    focus: 'rescue',
    tone: 'rescue',
    highlights: [
      ['核心角色', '交通員、村民、游擊隊'],
  ...
  },
  {
    ...
    location: '新界與市區交界',
    body:
      '在日常商業外衣掩護下，秘密據點逐步建立。像「廣恆」這類商舖既可作聯絡點，也能藏匿文件和人員，令港九大隊的運作更具隱蔽性。',
    focus: 'newTerritories',
    tone: 'base',
    highlights: [
      ['掩護方式', '商舖、倉庫、平民住所'],
  ...
  },
  {
    ...
    date: '1944.02.11',
    title: '克爾中尉飛機被擊落',
    subtitle: '美軍飛行員在啟德上空受創，隨即降落日佔區。',
    location: '啟德機場上空／九龍',
    body:
      '1944年2月11日，克爾中尉在香港上空執行任務時飛機被擊落。這宗事件後來引出港九大隊和地方群眾協助盟軍飛行員脫險的轉移故事。',
    focus: 'kerr',
    tone: 'attack',
    highlights: [
      ['日期', '1944-02-11'],
  ...
  },
  {
    ...
    location: '香港',
    body:
      '9月16日，日軍代表正式簽署投降文件。對港九大隊來說，這代表戰事正式落幕，也是長年秘密活動得以公開回顧的起點。',
    focus: 'postwar',
    tone: 'base',
    highlights: [
      ['正式程序', '簽署投降書'],
  ...
  },
  {
    ...
    location: '香港',
    body:
      '1998年的烈士名冊安放儀式，代表港九大隊的歷史記憶正式納入公共紀念與歷史保存層面。這一步讓這段抗戰歷史成為可供查考與展示的城市歷史檔案。',
    focus: 'postwar',
    tone: 'base',
    highlights: [
      ['日期', '1998-12-28'],
